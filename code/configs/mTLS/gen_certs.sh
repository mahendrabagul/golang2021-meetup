...
openssl req -new -x509 -days 365 -key grpc-root-ca.key -subj "/C=IN/ST=MH/L=Pune/O=Conf42/OU=Golang2021 Meetup/CN=RootCA" -out grpc-root-ca.crt -passin pass:1111 -set_serial 0 -extensions v3_ca -config ../openssl.cnf
...
echo "==================================================================="
openssl req -nodes -new -keyout grpc-server-ca.key -out grpc-server-ca.csr -subj "/C=IN/ST=MH/L=Pune/O=Conf42/OU=Golang2021 Meetup/CN=Server Intermediate CA" -config ../openssl.cnf -passout pass:1111
...
echo "==================================================================="
openssl req -nodes -new -keyout grpc-server.key -out grpc-server.csr -subj "/C=IN/ST=MH/L=Pune/O=Conf42/OU=Golang2021 Meetup/CN=golang2021.conf42.com" -config ../openssl.cnf -passout pass:1111
...
echo "==================================================================="
openssl req -nodes -new -keyout grpc-client-ca.key -out grpc-client-ca.csr -subj "/C=IN/ST=MH/L=Pune/O=Conf42/OU=Golang2021 Meetup/CN=Client Intermediate CA" -config ../openssl.cnf -passout pass:1111
...
echo "==================================================================="
openssl req -nodes -new -keyout grpc-client.key -out grpc-client.csr -subj "/C=IN/ST=MH/L=Pune/O=Conf42/OU=Golang2021 Meetup/CN=node-grpc-client3" -config ../openssl.cnf -passout pass:1111
